        ...
        wrap([$class: 'BuildUser']) {
            script {
                emailext(
                    ...
                    <td style="color:#22c55e;font-weight:bold;">${currentBuild.currentResult}</td></tr>
                    <tr><td><strong>Triggered By</strong></td>
                    <td>${env.BUILD_USER ?: 'System / Scheduler'}</td></tr>
                    </table>
    ...
    failure {
        wrap([$class: 'BuildUser']) {
            script {
                ...
                <tr><td><strong>Build Number</strong></td><td>#${env.BUILD_NUMBER}</td></tr>
                <tr><td><strong>Status</strong></td>
                <td style="color:#ef4444;font-weight:bold;">${currentBuild.currentResult}</td></tr>
                <tr><td><strong>Triggered By</strong></td>
                <td>${env.BUILD_USER ?: 'System / Scheduler'}</td></tr>
                </table>
